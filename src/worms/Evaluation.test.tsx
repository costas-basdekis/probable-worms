  ...
  describe("combineOptions", () => {
    ...
    it("combines 1 option as is", () => {
      expect(Evaluation.combineOptions([
        new Evaluation(new Results([[1, 1], [2, 1]]), new Results([[1, 1], [2, 2]])),
      ])).toEqual(new Evaluation(new Results([[1, 1], [2, 1]]), new Results([[1, 1], [2, 2]])));
    });
    it("combines 2 options by picking the max values", () => {
      expect(Evaluation.combineOptions([
        new Evaluation(new Results([[1, 1], [2, 0.5]]), new Results([[1, 1], [2, 2]])),
        new Evaluation(new Results([[1, 0.5], [2, 1]]), new Results([[1, 2], [2, 1]])),
      ])).toEqual(new Evaluation(new Results([[1, 1], [2, 1]]), new Results([[1, 2], [2, 2]])));
    });
  });
  ...
  describe("combineProbabilities", () => {
    ...
    it("combines 1 probability as is", () => {
      expect(Evaluation.combineProbabilities([
        {evaluation: new Evaluation(new Results([[1, 1], [2, 1]]), new Results([[1, 1], [2, 2]])), ratio: 1},
      ])).toEqual(new Evaluation(new Results([[1, 1], [2, 1]]), new Results([[1, 1], [2, 2]])));
    });
    it("combines 2 probabilities according to their weight", () => {
      expect(Evaluation.combineProbabilities([
        {evaluation: new Evaluation(new Results([[1, 0.5], [2, 1]]), new Results([[1, 1], [2, 0.5]])), ratio: 0.25},
        {evaluation: new Evaluation(new Results([[1, 0.25], [2, 0.75]]), new Results([[1, 0.5], [2, 1]])), ratio: 0.75},
